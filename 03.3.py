...
paevade_arv = 2
oobimise_hind = 15.5
print("Minu reis",sihtkoht,"Soome kestab" ,paevade_arv, "päeva ja üks öö maksab" ,oobimise_hind, "eurot.")
...
"""
raamatu_pealkiri = "Kalevipoeg"
lehekylgede_arv = 174
hindamisskoor = 8.9
print("Minu lemmikraamat on "+str(raamatu_pealkiri)+", mis on "+str(lehekylgede_arv)+" lehekülge pikk ja mille ma hindan "+str(hindamisskoor)+" punktiga.")
"""
